...
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER = 'resources\SPRITES\\guy.png'
...
def mainGame():
    ...
    playerFlapped = False # It is true only when the guy is flapping
...
def gameOver():
    ...
    SCREEN = pygame.display.set_mode((SCREENWIDTH, SCREENHEIGHT))
    pygame.display.set_caption('Flappy Guy With Digitalguy')
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Guy With Digitalguy') #Setting the Caption of The Game
